<template>
  <div class="page1">
    <div class="zcard">
      <h3 class="tit">{{curitem.cindex}}，{{curitem.tit}}（{{curitem.type==1?"多选":"单选"}}）</h3>
      <div class="card_con">
        <mt-checklist
          align="right"
          class="page-part"
          v-model="value1"
          :options="curitem.item"
          v-if="curitem.type==1"
          >
        </mt-checklist>
    ...
    <mt-button size="large" type="danger" :disabled="isdisable" class="J_sbtn" @click="goNext($event, false)" v-if="curIndex<tempTotal-1">下一题</mt-button>
